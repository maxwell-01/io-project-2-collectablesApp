...
class Functions extends TestCase
{
    public function testSuccessCreateBottlesHtmlAddBottle()
    {
        ...
        $expectedOutput =
            '<div class="bottleCard" id="dbId-1">
    ...
    public function testSuccessCreateBottlesHtmlEditBottle()
    {
        ...
        $actualOutput = createBottlesHtml($testInputPostArray, $testInputEditCardId);
        $this->assertEquals($expectedOutput, $actualOutput);
    }
    ...
    public function testSuccessCheckDropdownSubmissionWrongType()
    {
